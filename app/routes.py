...
def new_post():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('home'))
    return render_template('create_blog.html', title='New Post', form=form, legend='New Post')
...
#=============================================================================================
# PENDING CONFIRMATION FOR DELETTING A SINGLE COMMENT BECAUSE IT IS NOT PERFORMING AS EXPECTED
#=============================================================================================
